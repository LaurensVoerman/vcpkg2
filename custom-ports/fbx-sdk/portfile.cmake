...
if(VCPKG_TARGET_IS_WINDOWS)
    file(COPY "${SOURCE_PATH}/lib/${VCPKG_TARGET_ARCHITECTURE}/debug/alembic-md.lib" DESTINATION "${CURRENT_PACKAGES_DIR}/FBX/${VERSION}/${FBX_LIBDIR}/${VCPKG_TARGET_ARCHITECTURE}/debug/")
    file(COPY "${SOURCE_PATH}/lib/${VCPKG_TARGET_ARCHITECTURE}/debug/libfbxsdk-md.lib" DESTINATION "${CURRENT_PACKAGES_DIR}/FBX/${VERSION}/${FBX_LIBDIR}/${VCPKG_TARGET_ARCHITECTURE}/debug/")
    file(COPY "${SOURCE_PATH}/lib/${VCPKG_TARGET_ARCHITECTURE}/debug/libxml2-md.lib" DESTINATION "${CURRENT_PACKAGES_DIR}/FBX/${VERSION}/${FBX_LIBDIR}/${VCPKG_TARGET_ARCHITECTURE}/debug/")
    file(COPY "${SOURCE_PATH}/lib/${VCPKG_TARGET_ARCHITECTURE}/debug/zlib-md.lib" DESTINATION "${CURRENT_PACKAGES_DIR}/FBX/${VERSION}/${FBX_LIBDIR}/${VCPKG_TARGET_ARCHITECTURE}/debug/")
    file(COPY "${SOURCE_PATH}/lib/${VCPKG_TARGET_ARCHITECTURE}/release/alembic-md.lib" DESTINATION "${CURRENT_PACKAGES_DIR}/FBX/${VERSION}/${FBX_LIBDIR}/${VCPKG_TARGET_ARCHITECTURE}/release/")
    file(COPY "${SOURCE_PATH}/lib/${VCPKG_TARGET_ARCHITECTURE}/release/libfbxsdk-md.lib" DESTINATION "${CURRENT_PACKAGES_DIR}/FBX/${VERSION}/${FBX_LIBDIR}/${VCPKG_TARGET_ARCHITECTURE}/release/")
    file(COPY "${SOURCE_PATH}/lib/${VCPKG_TARGET_ARCHITECTURE}/release/libxml2-md.lib" DESTINATION "${CURRENT_PACKAGES_DIR}/FBX/${VERSION}/${FBX_LIBDIR}/${VCPKG_TARGET_ARCHITECTURE}/release/")
    file(COPY "${SOURCE_PATH}/lib/${VCPKG_TARGET_ARCHITECTURE}/release/zlib-md.lib" DESTINATION "${CURRENT_PACKAGES_DIR}/FBX/${VERSION}/${FBX_LIBDIR}/${VCPKG_TARGET_ARCHITECTURE}/release/")
