...
class TransferFunctionGradientProperty;
class TransferFunctionGradientLightingProperty;
class SampleDensityProperty;
class SampleDensityWhenMovingProperty;
class SampleDensityJitterProperty;
...
class PropertyVisitor
{
    public:
		...
		virtual void apply(TransferFunctionGradientProperty&) {}
		virtual void apply(TransferFunctionGradientLightingProperty&) {}
        virtual void apply(SampleDensityProperty&) {}
        virtual void apply(SampleDensityWhenMovingProperty&) {}
		virtual void apply(SampleDensityJitterProperty&) {}
...
class Property : public osg::Object
{
    public:
...
class CompositeProperty : public Property
{
    public:
        ...
        META_Object(osg_ibr, CompositeProperty);
...
class SwitchProperty : public CompositeProperty
{
    public:
        ...
        META_Object(osg_ibr, SwitchProperty);
...
class TransferFunctionProperty : public Property
{
    public:
        ...
        META_Object(osg_ibr, TransferFunctionProperty);
...
class TransferFunctionGradientProperty : public Property
{
    public:

        TransferFunctionGradientProperty(osg_ibr::GradientTransferFunction* tf = 0);

        /** Copy constructor using CopyOp to manage deep vs shallow copy.*/
        TransferFunctionGradientProperty(const TransferFunctionGradientProperty& tfp,const osg::CopyOp& copyop=osg::CopyOp::SHALLOW_COPY);

        META_Object(osg_ibr, TransferFunctionGradientProperty);

        virtual void accept(PropertyVisitor& pv) { pv.apply(*this); }

        /** Set the transfer function.*/
        void setTransferFunction(osg_ibr::GradientTransferFunction* tf) { _tf = tf; }

        /** Get the transfer function.*/
        osg_ibr::GradientTransferFunction* getTransferFunction() { return _tf.get(); }

        /** Get the const transfer function.*/
        const osg_ibr::GradientTransferFunction* getTransferFunction() const { return _tf.get(); }

    protected:

        virtual ~TransferFunctionGradientProperty() {}

		osg::ref_ptr<osg_ibr::GradientTransferFunction> _tf;
};

class TransferFunctionGradientLightingProperty : public Property
{
    public:

        TransferFunctionGradientLightingProperty(osg_ibr::GradientTransferFunction* tf = 0);

        /** Copy constructor using CopyOp to manage deep vs shallow copy.*/
        TransferFunctionGradientLightingProperty(const TransferFunctionGradientLightingProperty& tfp,const osg::CopyOp& copyop=osg::CopyOp::SHALLOW_COPY);

        META_Object(osg_ibr, TransferFunctionGradientLightingProperty);
    ...
    protected:
        ...
        virtual ~TransferFunctionGradientLightingProperty() {}
...
class ScalarProperty : public Property
{
    public:
        ...
        META_Object(osg_ibr, ScalarProperty);
...
class IsoSurfaceProperty : public ScalarProperty
{
    public:
        ...
        META_Object(osg_ibr, IsoSurfaceProperty);
...
class MaximumIntensityProjectionProperty : public Property
{
    public:
        ...
        META_Object(osg_ibr, MaximumIntensityProjectionProperty);
...
class LightingProperty : public Property
{
    public:
        ...
        META_Object(osg_ibr, LightingProperty);
...
class SampleDensityProperty : public ScalarProperty
{
    public:
        ...
        META_Object(osg_ibr, SampleDensityProperty);
...
/** Tells how much to jitter the ray size. 1 means full jitter, 0 means no jitter*/
class SampleDensityJitterProperty : public ScalarProperty
{
public:

	SampleDensityJitterProperty(float value = 1.0);

	SampleDensityJitterProperty(const SampleDensityJitterProperty& isp, const osg::CopyOp& copyop = osg::CopyOp::SHALLOW_COPY);

	META_Object(osg_ibr, SampleDensityJitterProperty);

	virtual void accept(PropertyVisitor& pv) { pv.apply(*this); }

protected:

	virtual ~SampleDensityJitterProperty() {}
};

/** Sample density to use when the volume is moving relative to the eye point.*/
class SampleDensityWhenMovingProperty : public ScalarProperty
{
    public:
        ...
        META_Object(osg_ibr, SampleDensityWhenMovingProperty);
...
class CollectPropertiesVisitor : public PropertyVisitor
{
    public:
		...
		virtual void apply(TransferFunctionGradientProperty& lp);
		virtual void apply(TransferFunctionGradientLightingProperty& lp);
        virtual void apply(SampleDensityProperty& sdp);
        virtual void apply(SampleDensityWhenMovingProperty& sdp);
		virtual void apply(SampleDensityJitterProperty& sdp);
		...
		osg::ref_ptr<TransferFunctionGradientProperty>			_transferFunctionGradientProperty;
		osg::ref_ptr<TransferFunctionGradientLightingProperty>	_transferFunctionGradientLightingProperty;
		...
		osg::ref_ptr<SampleDensityJitterProperty>				_sampleDensityJitterProperty;
